...
public class ImageIngestionStackWorking : Stack
{
    public ImageIngestionStackWorking(Construct scope, string id, ImageIngestionStackProps props = null) : base(scope, id, props)
    {
        // Create S3 buckets
