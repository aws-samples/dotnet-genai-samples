...
public class OpenSearchServerlessVectorStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var textModel = new Bedrock.TextModel(_bedrockRuntimeClient, _textModelId);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var embeddingModel = new Bedrock.EmbeddingModel(new AmazonBedrockRuntimeClient(), _embeddingModelId);
