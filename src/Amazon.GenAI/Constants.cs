...
public static class Constants
{
    ...
    //public static string TextModelId { get; set; } = "anthropic.claude-3-5-sonnet-20241022-v2:0";
    ...
    public static string AgentId { get; set; } = "BXZX6SB5KW";
    public static string AgentAliasId { get; set; } = "WP5KQ9IKG2";
